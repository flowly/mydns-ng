Summary: A MySQL-based DNS server
Name: mydns-mysql
Version: 1.2.8.31
Release: 1
Copyright: GPL
...
%description
A nameserver that serves records directly from your MySQL database.
...
%doc AUTHORS ChangeLog COPYING NEWS QUICKSTART.mysql README TODO
